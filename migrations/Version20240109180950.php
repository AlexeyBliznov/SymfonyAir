 ...
 */
final class Version20240109180950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT NOT NULL, airplane_id INT DEFAULT NULL, point_of_departure VARCHAR(100) NOT NULL, arrival_point VARCHAR(100) NOT NULL, date VARCHAR(255) NOT NULL, departure_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, arrival_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ticket (id INT NOT NULL, flight_id INT DEFAULT NULL, user_id INT DEFAULT NULL, ticket_number INT NOT NULL, seat_type VARCHAR(255) NOT NULL, seat_number VARCHAR(5) NOT NULL, price INT NOT NULL, book BOOLEAN NOT NULL, passenger_name VARCHAR(255) DEFAULT NULL, baggage VARCHAR(255) DEFAULT NULL, discount VARCHAR(255) DEFAULT NULL, boarding_confirm BOOLEAN NOT NULL, check_in BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ticket_option (ticket_id INT NOT NULL, option_id INT NOT NULL, PRIMARY KEY(ticket_id, option_id))');
        $this->addSql('CREATE INDEX IDX_20C46A7B700047D2 ON ticket_option (ticket_id)');
        $this->addSql('CREATE INDEX IDX_20C46A7BA7C41D6F ON ticket_option (option_id)');
        ...
        $this->addSql('ALTER TABLE ticket_option ADD CONSTRAINT FK_20C46A7B700047D2 FOREIGN KEY (ticket_id) REFERENCES ticket (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ticket_option ADD CONSTRAINT FK_20C46A7BA7C41D6F FOREIGN KEY (option_id) REFERENCES option (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_option DROP CONSTRAINT FK_20C46A7B700047D2');
        $this->addSql('ALTER TABLE ticket_option DROP CONSTRAINT FK_20C46A7BA7C41D6F');
